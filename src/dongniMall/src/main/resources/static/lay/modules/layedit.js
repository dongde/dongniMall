...
function js_beautify(t, e, i, n) {
    ...
    for (m = t, x = "", g = "TK_START_EXPR", v = "", y = [], S = !1, z = !1, L = !1, E = "\n\r\t ".split(""), k = "abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789_$".split(""), w = "+ - * / % & ++ -- = += -= *= /= %= == === != !== > < >= <= >> << >>> >>>= >>= <<= && &= | || ! !! , : ? ^ ^= |=".split(" "), C = "continue,try,throw,return,var,if,switch,case,default,for,while,break,function".split(","), b = "BLOCK", _ = [b], n = n || 0, A = 0, N = !1; ;) {
        ...
        switch (O) {
            case "TK_START_EXPR":
                z = !1, c("EXPRESSION"), "TK_END_EXPR" === g || "TK_START_EXPR" === g || ("TK_WORD" !== g && "TK_OPERATOR" !== g ? o() : f(x, C) && "function" !== x && o()), s();
                break;
            case "TK_END_EXPR":
                s(), u();
                break;
            ...
            case "TK_WORD":
                ...
                K = "NONE", "TK_END_BLOCK" === g ? f(h.toLowerCase(), ["else", "catch", "finally"]) ? (K = "SPACE", o()) : K = "NEWLINE" : "TK_END_COMMAND" !== g || "BLOCK" !== b && "DO_BLOCK" !== b ? "TK_END_COMMAND" === g && "EXPRESSION" === b ? K = "SPACE" : "TK_WORD" === g ? K = "SPACE" : "TK_START_BLOCK" === g ? K = "NEWLINE" : "TK_END_EXPR" === g && (o(), K = "NEWLINE") : K = "NEWLINE", "TK_END_BLOCK" !== g && f(h.toLowerCase(), ["else", "catch", "finally"]) ? a() : f(h, C) || "NEWLINE" === K ? "else" === v ? o() : ("TK_START_EXPR" !== g && "=" !== v || "function" !== h) && ("TK_WORD" !== g || "return" !== v && "throw" !== v ? "TK_END_EXPR" !== g ? "TK_START_EXPR" === g && "var" === h || ":" === v || ("if" === h && "TK_WORD" === g && "else" === x ? o() : a()) : f(h, C) && ")" !== v && a() : o()) : "SPACE" === K && o(), s(), x = h, "var" === h && (z = !0, L = !1);
                break;
            case "TK_END_COMMAND":
                s(), z = !1;
                break;
            ...
            case "TK_OPERATOR":
                ...
                "--" === h || "++" === h ? ";" === v ? (R = !0, P = !1) : (R = !1, P = !1) : "!" === h && "TK_START_EXPR" === g ? (R = !1, P = !1) : "TK_OPERATOR" === g ? (R = !1, P = !1) : "TK_END_EXPR" === g ? (R = !0, P = !0) : "." === h ? (R = !1, P = !1) : ":" === h && (R = !!v.match(/^\d+$/)), R && o(), s(), P && o();
                break;
...
layui.define(["layer", "form"], function (t) {
    ...
    var d = function (t, e, n) {
        ...
        a.css({height: n.height}).on("load", function () {
            ...
            d.append(r), d.append(f), c.attr("contenteditable", "true").css({"min-height": n.height}).html(e.value || ""), u.apply(l, [s, a, e, n]), g.call(l, s, t, n)
        })
    }, r = function (t) {
        ...
        d.on("keydown", function (t) {
            if (13 === t.keyCode) {
                var e = p(s), i = m(e), l = i.parentNode;
                if ("pre" === l.tagName.toLowerCase()) {
                    if (t.shiftKey) return;
                    return n.msg("请暂时用shift+enter"), !1
                }
                "body" === l.tagName.toLowerCase() && s.execCommand("formatBlock", !1, "<p>"), setTimeout(function () {
        ...
        var l = this.document, o = document.createElement(t), s = document.createElement("p");
        ...
        if (o.removeAttribute("text"), a.ie) {
            ...
            "p" != t && "div" != t && "P" != u.tagName && "<br>" != c.innerHTML ? s.appendChild(o) : s = o, "<br>" != c.innerHTML && "div" != t || (i.selectNode(c), i.deleteContents()), i.deleteContents(), i.insertNode(s), "img" == t && "<br>" == c.innerHTML && (l.execCommand("formatBlock", !1, "<p>"), l.execCommand("justifyCenter"), setTimeout(function () {
                body.focus()
            }, 10))
        }
    }, h = function (t, e) {
        ...
        var a = t.document, s = i(a.body), d = {
            link: function (e) {
                ...
                v.call(s, {
                    ...
                    if ("A" === n.tagName) n.href = i.url, n.rel = i.rel, "" == i.rel && n.removeAttr("rel"), n.target = i.target, "_self" != i.target && void 0 != i.target || n.removeAttr("target"), "" != i.text && (n.text = i.text); else {
                        ...
                        "" != i.rel && void 0 != i.rel || delete l.rel, "_self" != i.target && void 0 != i.target || delete l.target, "" == i.text && (l.text = l.href), y.call(t, "a", l, e)
                    }
                })
            }, unlink: function (t) {
                a.execCommand("unlink")
            }, face: function (e) {
                T.call(this, {facePath: l.facePath}, function (i) {
                    y.call(t, "img", {src: i.src, alt: i.alt}, e), setTimeout(function () {
                        s.focus()
                    }, 10)
                })
            }, image: function (e) {
                ...
                A.call(s, {hide: i.hide, default: i.default}, function (i) {
                    y.call(t, "pre", {text: i.code, "lay-lang": i.lang}, e), setTimeout(function () {
                        s.focus()
                    }, 10)
                })
            }, images: function (e) {
                n.open({
                    ...
                    yes: function (i, l) {
                        var a = "";
                        "" != l.find('input[name="imgWidth"]').val() && (a += "width:" + l.find('input[name="imgWidth"]').val() + "px;"), "" != l.find('input[name="imgHeight"]').val() && (a += "height:" + l.find('input[name="imgHeight"]').val() + "px;"), 0 === l.find("#imgsPrev").find("img").length ? n.msg("请选择要插入的图片") : (y.call(t, "p", {text: l.find("#imgsPrev").html().replace(new RegExp(/(max-width:70px;margin:2px)/g), a)}, e), n.close(i))
                    },
                    btn2: function (t, e) {
                    ...
                    cancel: function () {
                        if (layero.find("#imgsPrev img").length > 0) {
                            ...
                            var n = l.calldel;
                            "" != n.url && i.post(n.url, {imgpath: t}, function (t) {
                                n.done(t)
                            })
                        }
                    },
                        ...
                        layui.use("upload", function () {
                            ...
                            e.render({
                                ...
                                error: function (t, e) {
                                    ...
                                    0 == e.code ? (e.data = e.data || {}, i("#imgsPrev img:last")[0].src = e.data.src, a.done(e)) : 2 == e.code ? (e.data = e.data || {}, i("#imgsPrev img:last")[0].src = e.data.src, a.done(e)) : n.msg(e.msg || "上传失败"), t.find(".layui-upload-img").on("click", function () {
                ...
                n.open({
                    ...
                    yes: function (i, l) {
                        ...
                        "" != l.find('input[name="imgWidth"]').val() && (a += "width:" + l.find('input[name="imgWidth"]').val() + "px;"), "" != l.find('input[name="imgHeight"]').val() && (a += "height:" + l.find('input[name="imgHeight"]').val() + "px;"), "" == s.val() ? n.msg("请选择一张图片或输入图片地址") : (y.call(t, "img", {
                            src: s.val(),
                            alt: o.val(),
                            style: a
                        }, e), n.close(i))
                    ...
                    cancel: function () {
                        var t = l.calldel;
                        "" != t.url && i.post(t.url, {imgpath: layero.find('input[name="Imgsrc"]').val()}, function (e) {
                            t.done(e)
                        })
                    },
                    success: function (t, e) {
                ...
                a.video.title.length > 0 && (o = AddCustomThemes(a.video.title, a.video.content, a.video.preview)), n.open({
                    ...
                    btnAlign: "c",
                    yes: function (i, o) {
                        var s = o.find('input[name="video"]'), d = o.find('input[name="cover"]'),
                            r = o.find('select[name="theme"]');
                        if ("" == s.val()) n.msg("请选择一个视频或输入视频地址"); else {
                            var c = '&nbsp;<video src="' + s.val() + '" style="    width: 100%;" poster="' + d.val() + '" ' + ' controls="controls" >您的浏览器不支持video播放</video>&nbsp;',
                                u = "";
                            a.video.title.length > 0 && r.length > 0 && (u = r[0].options[r[0].selectedIndex].value), y.call(t, "p", {
                                text: c,
                                class: u
                            }, e), n.close(i)
                        }
                ...
                n.open({
                    ...
                    btnAlign: "c",
                    yes: function (i, l) {
                        0 === l.find("#filesPrev").find("a").length ? n.msg("请选择要上传的附件") : (y.call(t, "p", {text: l.find("#filesPrev").html()}, e), n.close(i))
                    },
                    success: function (t, e) {
                        layui.use("upload", function () {
                            var e = layui.upload, a = l.uploadFiles || {}, o = [];
                            e.render({
                                ...
                                error: function (t, e) {
                                    ...
                                    0 == e.code ? (e.data = e.data || {}, i("#filesPrev a:last")[0].href = e.data.src, a.done(e)) : 2 == e.code ? (n.msg(e.msg || "上传失败"), e.data = e.data || {}, i("#filesPrev a:last")[0].href = e.data.src) : n.msg(e.msg || "上传失败"), t.find(".layui-upload-img").on("click", function () {
                                        n.confirm("是否删除该附件?", {icon: 3, title: "提示"}, function (t) {
                                            var e = l.calldel;
                                            "" != e.url ? i.post(e.url, {imgpath: this.src}, function (t) {
                                                i("#filesPrev a:last")[0].remove(), e.done(t)
                                            }) : (n.msg("没有配置回调参数"), i("#filesPrev a:last")[0].remove()), n.close(t)
                                        })
                                    })
                                }
                            })
                ...
                var n = this, a = n.parentElement.nextElementSibling.firstElementChild.contentDocument.body.innerHTML;
                if (a = style_html(a, 4, " ", 80), -1 == n.parentElement.nextElementSibling.lastElementChild.id.indexOf("aceHtmleditor")) {
                    n.parentElement.nextElementSibling.setAttribute("style", "z-index: 999; overflow: hidden;height:" + l.height), null !== this.parentElement.parentElement.getAttribute("style") && n.parentElement.nextElementSibling.setAttribute("style", "z-index: 999; overflow: hidden;height:100%"), n.parentElement.nextElementSibling.firstElementChild.style = "position: absolute;left: -32768px;top: -32768px;";
                    var o = document.createElement("div");
                    o.setAttribute("id", n.parentElement.nextElementSibling.firstElementChild.id + "aceHtmleditor"), o.setAttribute("style", "left: 0px;top: 0px;width: 100%;height: 100%"), n.parentElement.nextElementSibling.appendChild(o);
                    var s = ace.edit(n.parentElement.nextElementSibling.firstElementChild.id + "aceHtmleditor");
                    s.setFontSize(14), s.session.setMode("ace/mode/html"), s.setTheme("ace/theme/tomorrow"), s.setValue(a), s.setOption("wrap", "free"), s.gotoLine(0), i(n).siblings("i").addClass("layui-disabled"), i(n).siblings(".layedit-tool-fullScreen").removeClass("layui-disabled"), i(n).removeClass("layui-disabled")
                } else {
                    var s = ace.edit(n.parentElement.nextElementSibling.firstElementChild.id + "aceHtmleditor");
                    t.document.body.innerHTML = s.getValue(), n.parentElement.nextElementSibling.removeAttribute("style"), this.parentElement.nextElementSibling.firstElementChild.style = "height:" + l.height, this.parentElement.nextElementSibling.lastElementChild.remove(), i(n).siblings("i").removeClass("layui-disabled")
                }
                ...
                }, i = {}, n = {}, o = e.code, d = e.text, r = function () {
                ...
                E.call(this, {fonts: r, texts: c}, function (t) {
                ...
                }, n = {}, a = {}, o = i.code, d = i.text, r = function () {
                    return layui.each(o, function (t, e) {
                        n[t] = e
                    }), n
                }(), c = function () {
                ...
                k.call(this, {fonts: r, texts: c}, function (i) {
                    y.call(t, "span", {style: i, text: "&nbsp;"}, e), setTimeout(function () {
                        s.focus()
                    }, 10)
                })
            }, fontSize: function (e) {
                ...
                w.call(this, {fonts: r, texts: c}, function (i) {
                    y.call(t, "span", {style: i, text: "&nbsp;"}, e), setTimeout(function () {
                        s.focus()
                    }, 10)
                })
                ...
                _.call(this, function (i) {
                    ...
                    y.call(t, "table", {text: n}, e), setTimeout(function () {
                        s.focus()
                    }, 10)
                })
            }, addhr: function (e) {
        ...
        }, r = e.find(".layui-layedit-tool"), c = function () {
            ...
            if (!e.hasClass(o)) {
                ...
                l ? (/justifyLeft|justifyCenter|justifyRight/.test(l) && "BODY" === u.parentNode.tagName && a.execCommand("formatBlock", !1, "<p>"), a.execCommand(l), setTimeout(function () {
                    s.focus()
                }, 10)) : d[n] && d[n].call(this, c, a), h.call(t, r, e)
            }
        }, u = /image/;
        r.find(">i").on("mousedown", function () {
            ...
            h.call(t, r), n.close(T.index), n.close(_.index), n.close(E.index)
        });
        var f = null, g = function (e) {
            if (null != e) {
                n.close(f);
                var a, o;
                switch (a = e.target, o = a.parentNode, a.tagName) {
                    ...
                    case "VIDEO":
                        ...
                        s.video.title.length > 0 && (d = AddCustomThemes(s.video.title, s.video.content, s.video.preview)), f = n.open({
                            type: 1,
                            id: "fly-jie-video-upload",
                            title: "视频管理",
                            shade: .05,
                            ...
                            yes: function (e, i) {
                                ...
                                if ("" == l.val()) n.msg("请选择一个视频或输入视频地址"); else {
                                    var d = '&nbsp;<video src="' + l.val() + '" poster="' + a.val() + '" controls="controls" >您的浏览器不支持video播放</video>&nbsp;',
                                        r = "";
                                    s.video.title.length > 0 && o.length > 0 && (r = o[0].options[o[0].selectedIndex].value), y.call(t, "div", {
                                        text: d,
                                        class: r
                                    }, range), n.close(e)
                                }
        ...
        E.hide = E.hide || function (t) {
            ...
            tips: 1, time: 0, skin: "layui-box layui-util-face", success: function (l, a) {
                l.css({marginTop: -4, marginLeft: -10}).find(".layui-clear>li").on("click", function () {
                    e && e(this.title, t.fonts), n.close(a)
